...
class CdgPacketReader:
    ...
    def __cdgBorderPreset(self, packd):
        ...
        self.__cdgPixelColours[:, :12] = (
            self.__cdgPixelColours[:, :12] + self.__cdgBorderColourIndex
        )
        self.__cdgPixelColours[:, -12:] = N.zeros([CDG_FULL_WIDTH, 12])
        self.__cdgPixelColours[:, -12:] = (
            self.__cdgPixelColours[:, -12:] + self.__cdgBorderColourIndex
        ...
        self.__cdgPixelColours[:6, 12:-12] = (
            self.__cdgPixelColours[:6, 12:-12] + self.__cdgBorderColourIndex
        )
        self.__cdgPixelColours[-6:, 12:-12] = N.zeros([6, CDG_FULL_HEIGHT - 24])
        self.__cdgPixelColours[-6:, 12:-12] = (
            self.__cdgPixelColours[-6:, 12:-12] + self.__cdgBorderColourIndex
